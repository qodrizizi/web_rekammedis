...
@section('content')
        ...
        <div class="bg-white shadow-xl rounded-2xl p-6 border border-gray-100">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center mb-6 space-y-4 md:space-y-0">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <select class="p-2 border border-gray-300 rounded-xl text-sm focus:ring-yellow-500 focus:border-yellow-500 transition-colors hidden sm:block">
    ...
    <div id="modalAddPasien" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 p-4">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
            ...
            {{-- Form action diubah ke route petugas.pasien.store --}}
            <form id="formAddPasien" action="{{ route('petugas.pasien.store') }}" method="POST" class="p-6 space-y-4">
                @csrf
    ...
    <script>
        ...
        function editPasien(data) {
            ...
            // Menggunakan route untuk petugas
            form.action = "{{ url('petugas/pasien') }}/" + data.id; 
        ...
        function deletePasien(id, info) {
            ...
            // Menggunakan route untuk petugas
            form.action = "{{ url('petugas/pasien') }}/" + id; 
